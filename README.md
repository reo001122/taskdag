...
例外は GitHub Issues です。ここでは Issue 同士に「これがこれをブロックしている」という関係を
登録でき、**ブロックされている状態は自動的に付きます**。手でラベルを貼るのではなく、登録した
関係から決まる —— この製品が狙っていることと同じです。ただしそれは Issue 一覧に出るバッジと
して読むもので、**依存の全体像を絵として見ることも、その絵の上で操作することもできません**。
